...
plt.plot(W1,i1_star[:,int(len(W2)/2),0],label="$i1$")
plt.plot(W1,i2_star[:,int(len(W2)/2),0],label="$i2$")
plt.legend()
plt.xlabel('y')
...
plt.plot(W2,i1_star[int(len(W1)/2),:,0],label="$i1$")
plt.plot(W2,i2_star[int(len(W1)/2),:,0],label="$i2$")
plt.legend()
plt.xlabel('z')
plt.title('Investment-Capital Ratio')  
# plt.xlim([-0.02, 0.02])
